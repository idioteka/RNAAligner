...
struct ThreadData3 {
	...
	ThreadData3(int thread_id_, int *sizes_, int *sites_, vector<Read> *reads_, int start_, int stop_, Config *config_, string *whole_genome_, vector<Result> *results_, vector<Read> *aligned_reads_, vector<Read> *unaligned_reads_) {
